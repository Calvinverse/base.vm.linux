...
'@
    ...
    Context 'has been daemonized' {
        It 'with default configuration in /etc/telegraf/telegraf.d/system' {
            '/etc/telegraf/telegraf.d/inputs-statsd.conf' | Should Exist
            '/etc/telegraf/telegraf.d/inputs-system.conf' | Should Exist

            '/etc/telegraf/telegraf.d/outputs-statsd.conf' | Should Exist
            '/etc/telegraf/telegraf.d/outputs-system.conf' | Should Exist
        }
